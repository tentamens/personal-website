<template>
  <div class="min-h-screen bg-background text-foreground dark">
    <!-- Header -->
    <header class="sticky top-0 z-50 bg-card/95 backdrop-blur-sm border-b border-border">
      <div class="max-w-4xl mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <h1 class="text-xl font-sans font-semibold">Thomas Griffin </h1>
          </div>
    ...
    <main class="max-w-4xl mx-auto px-6 py-8">
      <!-- Hero Section -->
      <div class="bg-card rounded-xl p-8 mb-8 border border-border">
        <div class="space-y-4">
          <h1 class="text-3xl font-sans font-bold mb-4">Privacy Policy</h1>      
            <p>
                    Thomas Griffin built the Swing Stack game as
                    an Ad Supported game. This SERVICE is provided by
                    Thomas Griffin at no cost and is intended for
                    use as is.
                  </p> <p>
                    ...
                    Swing Stack unless otherwise defined in this Privacy
                    Policy.
                    ...
                    me at Losttentdevelopment@gmail.com.
                  </p>
        </div>
      </div>
...
const gameData = ref({
  gameName: 'Epic Quest Adventures',
  companyName: 'GameStudio Inc.',
  contactEmail: 'privacy@gamestudio.com',
  lastUpdated: 'December 15, 2024',
  effectiveDate: 'December 15, 2024',
  website: 'https://epicquestgame.com',
  address: '123 Game Street, Tech City, TC 12345'
})
...
const sections = ref([
  ...
  },
  {
    id: 'data-sharing',
    title: 'Data Sharing',
    content: 'We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as described in this policy. We may share information with trusted service providers who assist us in operating our game, conducting our business, or serving our users.'
  },
  {
    id: 'data-security',
    title: 'Data Security',
  ...
  },
  {
    ...
    content: 'Our game is not intended for children under 13. We do not knowingly collect personal information from children under 13. If we become aware that we have collected personal information from a child under 13, we will take steps to delete such information.'
  },
  {
    id: 'your-rights',
    title: 'Your Rights',
